...
#define SINA_WEIBO_APP_KEY          @"2884389785"
#define SINA_WEIBO_APP_SECRET       @"c8c252c6a59d7c907c89cbf1d01655c5"
...
- (void)getFriendsOfUser:(NSString*)uid cursor:(NSString *)cursor count:(NSInteger)count doneCallback:(processDoneWithDictBlock)callback
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithCapacity:2];
